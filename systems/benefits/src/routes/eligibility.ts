 ...
 *
 * In a production system this would call the identity system to fetch the
 ...
 * cross-system check will be wired up via OpenFn.
 */
router.post(
  "/check",
  asyncHandler(async (req, res) => {
    ...
    // Stub: always eligible. Real implementation would call identity system.
    const eligible = true;
